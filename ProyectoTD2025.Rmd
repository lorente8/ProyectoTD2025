...
#Podemos ver que en 168 tickets se vende fruta o verdura, y en 24 tickets se vende pescado
```
...
12-¿Cuál es las categoría de productos con mayor venta en términos de cantidad, y cuál es su contribución porcentual al total de unidades vendidas?
```{r}
...
```{r}
df_final %>% summarise(total_importe = sum(ingreso_total, na.rm = TRUE),
                       importe_pescado = sum(ingreso_total[tipo == "fruta_verdura"], na.rm = TRUE),
                       porcentaje_importe_pescado = importe_pescado / total_importe * 100)
