...
```{r, echo=FALSE}
# Productos menos vendidos por unidades
...
# Mostrar la tabla de productos menos vendidos por unidades
productos_menos_vendidos_unidades <- head(unidades_ordenadas, n = 3)
productos_menos_vendidos_unidades %>%
  kable(caption = "Top 3 productos menos vendidos por unidades")

# Productos menos vendidos por kilos (pescado y fruta_verdura)
...
# Mostrar la tabla de productos menos vendidos por kilos
productos_menos_vendidos_kilos <- head(kilos_ordenados, n = 3)
productos_menos_vendidos_kilos %>%
  kable(caption = "Top 3 productos menos vendidos por kilos")
...
```
 Como vemos Alistado Mediano con 31.33 es mayor 
...
```
Respuesta: Se han identificado pares de productos más frecuentemente comprados juntos, donde uno de ellos es casi siempre QUESO LONCHAS CABRA. Eso sugiere que este producto es muy popular y acompaña a muchos otros productos a la misma compra.
