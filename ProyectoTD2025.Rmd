...
-Tercera fila: Detalles del precio (ej. "0.390 kg 6.95 €/kg 2.71")
...
for (i in seq_along(filas_pescado)) {
  ...
  nombre_producto <- df_producto$productos[idx + 1]  # Nombre está en la siguiente fila
  ...
  # Extraer valores (asumiendo el orden: peso, unidad, precio_kg, moneda, precio_total)
  if (length(detalles_split) >= 5) {
    ...
    warning(paste("Formato inesperado en el ticket", num_ticket, "Detalles:", detalles))
  }
}

# Combinar todos los registros
df_pescado <- do.call(rbind, datos_pescado)
