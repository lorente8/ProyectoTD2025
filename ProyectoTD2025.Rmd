...
Las variables finales obtenidas se pueden observar en la Tabla \ref(tab:tabla-variables).

En la Tabla \ref{tab:tabla_datos} se presentan las primeras observaciones del conjunto de datos procesado, que incluye información extraída de los tickets,
